...
class editprofilewithoutnama {
	...
	public void user_input_nama() {
		WebUI.callTestCase(findTestCase('Pages/Profile/Input Nama 2'), [('nama') : ''], FailureHandling.STOP_ON_FAILURE)
	}
	...
	public void user_input_alamat() {
		WebUI.callTestCase(findTestCase('Pages/Profile/Input Alamat'), [('alamat') : 'jl surabaya'], FailureHandling.STOP_ON_FAILURE)
	}

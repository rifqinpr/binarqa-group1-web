...
WebUI.click(findTestObject('Object Repository/Page_kategori/Hobi'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_kategori/Verify_content'), 0)

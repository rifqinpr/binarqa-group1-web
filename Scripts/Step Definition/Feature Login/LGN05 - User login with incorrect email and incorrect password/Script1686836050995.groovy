...
WebUI.callTestCase(findTestCase('Pages/Login/Input Email'), [('email') : 'groupsatuuu@gmail.com'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Login/Input Password'), [('password') : '12333!'], FailureHandling.STOP_ON_FAILURE)

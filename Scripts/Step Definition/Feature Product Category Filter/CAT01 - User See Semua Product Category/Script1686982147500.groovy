...
WebUI.callTestCase(findTestCase('Pages/Homepage/Category Filter Button/Verify First Product Card Category'), [('textExpected') : '\\bBaju|\\bElektronik|\\bHobi|\\bKendaraan|\\bKesehatan'
        , ('isRegex') : true], FailureHandling.STOP_ON_FAILURE)
